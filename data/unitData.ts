...
export const UNIT_DATA: Record<string, Record<string, UnitStats>> = {
  ...
  elf: {
    ...
    Lanceman: { melee: 3, short: 0, range: 0, defense: 3, base_gold_cost: 220, equipment_iron_cost: 5, equipment_wood_cost: 3, equipment_gold_cost: 0, upkeep: { gold: 10, food: 2 }, weaponType: 'blade', armorType: 'light', equipment: { "Lance": 1, "Light Armor": 1 }, isInfantry: false, isPikeman: true, isMounted: false },
    Caragous: { melee: 10, short: 0, range: 0, defense: 11, base_gold_cost: 1295, equipment_iron_cost: 13, equipment_wood_cost: 5, equipment_gold_cost: 0, upkeep: { gold: 12, food: 4 }, weaponType: 'blade', armorType: 'heavy', equipment: { "Lance": 1, "Sword": 1, "Caragous Armor": 1, "Horse": 1 }, isInfantry: false, isPikeman: false, isMounted: true },
  ...
  gnome: {
    ...
    Militia: { melee: 1, short: 0, range: 0, defense: 1, base_gold_cost: 100, equipment_iron_cost: 2, equipment_wood_cost: 3, equipment_gold_cost: 0, upkeep: { gold: 1, food: 1 }, weaponType: 'blade', armorType: undefined, equipment: { "Spear": 1 }, isInfantry: false, isPikeman: true, isMounted: false },
  ...
  human: {
    ...
    Pikeman: { melee: 4, short: 0, range: 0, defense: 3, base_gold_cost: 280, equipment_iron_cost: 5, equipment_wood_cost: 3, equipment_gold_cost: 0, upkeep: { gold: 4, food: 2 }, weaponType: 'blade', armorType: 'light', equipment: { "Spear": 1, "Light Armor": 1 }, isInfantry: false, isPikeman: true, isMounted: false },
  ...
  orc: {
    ...
    Rusher: { melee: 4, short: 0, range: 0, defense: 3, base_gold_cost: 210, equipment_iron_cost: 3, equipment_wood_cost: 2, equipment_gold_cost: 0, upkeep: { gold: 4, food: 3 }, weaponType: 'blade', armorType: 'light', equipment: { "Axe": 1, "Leather Armor": 1, "Wolf": 1 }, isInfantry: false, isPikeman: false, isMounted: true },
    Slother: { melee: 2, short: 0, range: 0, defense: 2, base_gold_cost: 105, equipment_iron_cost: 1, equipment_wood_cost: 3, equipment_gold_cost: 0, upkeep: { gold: 2, food: 2 }, weaponType: 'blade', armorType: undefined, equipment: { "Spear": 1, "Wolf": 1 }, isInfantry: false, isPikeman: true, isMounted: true },
  ...
  undead: {
    ...
    WraithPikeman: { melee: 4, short: 0, range: 0, defense: 4, base_gold_cost: 285, equipment_iron_cost: 4, equipment_wood_cost: 3, equipment_gold_cost: 0, upkeep: { gold: 6, food: 0 }, weaponType: 'blade', armorType: 'light', equipment: {}, isInfantry: false, isPikeman: true, isMounted: false },
